 ...
 *
 * The route file above this one decides whether to render it at all: a visitor
 * who already has a session is sent to the dashboard instead of being shown a
