        ...
        switch (payload.type) {
            ...
            case 'custom_tool_call': {
                ...
                return [{
                        ...
                        summary: (0, types_1.preview)(typeof input === 'string' ? input : JSON.stringify(input ?? '')),
                        input,
                        id: callIdOf(payload),
                        at,
                    }];
            ...
            case 'function_call': {
                ...
                return [{
                        kind: 'tool_call',
                        name: String(payload.name || 'tool'),
                        summary: (0, types_1.preview)(typeof payload.arguments === 'string'
                            ? payload.arguments
            ...
            case 'function_call_output': {
                return [{
                        ...
                        ok: true,
                        preview: (0, types_1.preview)(textOf(payload.output)),
                        at,
                    }];
            }
            default:
